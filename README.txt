...
Acest modul descarca automat datele de identificare atunci cand treci CUI-ul in formular de finalizare comanda.
Pentru firmele platitoare de TVA se va adauga fara "RO"

Pentru support: mihai@icey.ro

== Installation ==

1. incarci arhiva 'date-cif-anaf.zip' in plugins-> add new -> upload
2. activezi modulul
3. bafta!
